...
1. Create a new GitHub repository for this project called `pandas-challenge`. **Do not add this homework to an existing repository**.
...
5. `Add`, `commit`, and `push` the above changes to GitHub.
